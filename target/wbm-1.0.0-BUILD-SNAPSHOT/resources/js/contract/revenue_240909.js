...
$(document).ready(function () {
    ...
    function listRevenueInfo(pageIndex, isRefresh = 0) {
        ...
        for (let keyValue of resultJson.resultData) {
            ...
            resultData += "</td>";
            // console.log('tsi_contract_pric',keyValue.tsi_contract_pric);

            // console.log("tsi_contract_price=", numberWithCommas(keyValue.tsi_contract_price )|| 0);
            // console.log("tsi_contract_vat=", numberWithCommas(keyValue.tsi_contract_vat )|| 0);
            // console.log("tpi_price", numberWithCommas(keyValue.tpi_price )|| 0);
            // console.log("tpi_price_vat", numberWithCommas(keyValue.tpi_price_vat )|| 0);
            // console.log('수정필요');

            resultData += "<td>" + numberWithCommas(keyValue.tsi_contract_price) || 0 + "</td>";
            resultData += "<td>" + numberWithCommas(keyValue.tsi_contract_vat) || 0 + "</td>";
            resultData += "<td>" + numberWithCommas(keyValue.tpi_price) || 0 + "</td>";
            resultData += "<td>" + numberWithCommas(keyValue.tpi_price_vat) || 0 + "</td>";
        ...
        $("#total_contract_price").text(numberWithCommas(total_contract_price));
        $("#total_contract_vat").text(numberWithCommas(total_contract_vat));
        $("#total_sprice").text(numberWithCommas(total_sprice));
        $("#total_price_vat").text(numberWithCommas(total_price_vat));
