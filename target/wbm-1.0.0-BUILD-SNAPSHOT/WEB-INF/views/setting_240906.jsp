                    ...
                    <form action="">
                        <div class="input_row_wrap">
                            ...
                            <div class="input_btn_wrap">
                                <button type="button" id="btn_add_section"><div>추가</div></button>
                                <button type="button" id="btn_edit_section"><div>수정</div></button>
                                <button type="button" id="btn_del_section"><div>삭제</div></button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div>
                    <form action="">
                        <div class="input_row_wrap">
                            ...
                            <div class="input_btn_wrap">
                                <button type="button" id="btn_add_contractor"><div>추가</div></button>
                                <button type="button" id="btn_edit_contractor"><div>수정</div></button>
                                <button type="button" id="btn_del_contractor"><div>삭제</div></button>
                            </div>
                        </div>
                    </form>
                </div>
