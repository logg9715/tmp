            ...
            <div class="top_content">
                <div class="btn_sort_wrap">
                    <div style="position: relative;">
                        <button type="button" id="BtnSort" class="click_outside_modal_btn"><span class="icon"></span><p>정렬</p></button>
                        <button type="button">
                            ...
                            <form action="" id="sortForm">
                                <div class="sortFormWrap">
                                    <div id="AddedsortList">
                                        ...
                                        <div class="sortListRow">
                                            <div class="sortTitle" sort_type="3"><span class="icon"></span><p>건명(사업명)</p></div>
                                            <div class="inputRow" data-role="selectBox">
                                                <div class="selectBox">
                                                    <button type="button" class="BtnSelect">
                                                        <div id="SortVal3" class="selSortValue" value="-1">정렬</div>
                                        ...
                                        <div class="sortListRow">
                                            <div class="sortTitle" sort_type="4"><span class="icon"></span><p>계약금액</p></div>
                                            <div class="inputRow" data-role="selectBox">
                                                <div class="selectBox">
                                                    <button type="button" class="BtnSelect">
                                                        <div id="SortVal3" class="selSortValue" value="-1">정렬</div>
                                        ...
                                        <div class="sortListRow">
                                            <div class="sortTitle" sort_type="5"><span class="icon"></span><p>매출금액</p></div>
                                            <div class="inputRow" data-role="selectBox">
                                                <div class="selectBox">
                                                    <button type="button" class="BtnSelect">
                                                        <div id="SortVal3" class="selSortValue" value="-1">정렬</div>
                                        ...
                                        <div class="sortListRow">
                                            <div class="sortTitle" sort_type="6"><span class="icon"></span><p>계산서발행일</p></div>
                                            <div class="inputRow" data-role="selectBox">
                                                <div class="selectBox">
                                                    <button type="button" class="BtnSelect">
                                                        <div id="SortVal3" class="selSortValue" value="-1">정렬</div>
