    ...
    <div class="content_wrap">
            ...
            <div class="btn_wrap top_right">
                <c:choose>
                    <c:when test="${loginLevel != null and loginLevel > 70}">
                        ...
                        <button type="button" class="btn_nextStep" value=1>
                            <div>
                                <p>다음 단계 이동</p>
                                <span class="level_icon"></span>
                            </div>
        ...
        <div class="list" id="mainList">
            <table>
                <thead>
                    <tr>
                        <th style="width: 64px"><input type="checkbox" name="" check_name="mainList" id="mainListCheckAll" class="check_all" /> <label for="mainListCheckAll"></label></th>
    ...
    <div class="modal_wrap">
        ...
        <div class="modal_main">
                        ...
                        <div class="form_top">
                            ...
                            <div class="form_left">
                                ...
                                <div class="input_row">
                                    ...
                                    <div class="input_wrap inputs_bundle"><input type="text" id="salesContractPrice" name="salesContractPrice" placeholder="VAT포함" /><input type="text" id="salesContractVat" name="salesContractVat" placeholder="VAT별도" />
            ...
            <div id="new_contract_form">
                ...
                <!-- 계약 버튼 시작-->
                <div class="modal_bottom">
                    <button type="button" class="info_nextstep" id="contract_info_nextstep" value="2">
                        <div>다음단계</div>
                    </button>
                    <button type="button" class="info_prevstep" id="contract_info_prevstep" value="-2">
                        <div>이전단계</div>
                    </button>
                            ...
                            <div class="form_top">
                                <div class="form_left">
                                    ...
                                    <div class="input_row">
                                        ...
                                        <div class="input_wrap">
                                            <div class="select_box">
                                                <input type="text" id="productRate" name="productRate" placeholder="% " /><i>(%)</i>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="input_row">
                            ...
                            <div class="form_top">
                                <div class="form_left">
                                    ...
                                    <div class="input_row">
                                        ...
                                        <div class="input_wrap">
                                            <div class="select_box">
                                                <input type="text" id="workRate" name="workRate" placeholder="% " /><i>(%)</i>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="input_row">
