...
<!-- modal 시작 -->
<div class="modal">
	<div class="modal_wrap inventory_sub_modal">
		<div class="modal_top">
				...
				<form id="form_inventory_sub" name="form_inventory_sub" action="">
					<div class="input_row">
						...
						<div class="input_wrap">
							<div class="select_box">
								<select name="sel_inventory_type" id="sel_inventory_type" tabindex="1">
					...
					<div class="form_inventory_row_bundle">
						<div class="input_row">
							...
							<div class="input_wrap">
								<input type="text" id="text_event_type" name="text_event_type" tabindex="2" />
							</div>
						</div>
						<div class="input_row">
							<div class="input_tit">
							...
							<div class="input_wrap">
								<input type="date" id="date_event_day" name="date_event_day"  tabindex="3"/>
							</div>
						</div>
					</div>
					<div class="form_inventory_row_bundle">
						<div class="input_row">
							...
							<div class="input_wrap">
								<input type="text" id="text_count" name="text_count"  tabindex="4"/>
							</div>
						</div>
						<div class="input_row">
							<div class="input_tit">
							...
							<div class="input_wrap">
								<input type="text" id="text_price" name="text_price"  tabindex="5"/>
							</div>
						</div>
					</div>
					<div class="form_inventory_row_bundle">
						...
						<div class="input_row">
							...
							<div class="input_wrap">
								<input type="text" id="text_recipient" name="text_recipient" tabindex="7"/>
							</div>
						</div>
					</div>
						...
						<div class="input_wrap">
							<div class="editor">
								...
								<div class="editor_input">
									<div id="inventoryEditor" contenteditable="true" class="editor_box" tabindex="8"></div>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="modal_bottom">
			<div>
				<button type="button" id="btn_info_edit" class="info_edit" tabindex="9">
					<div>수정</div>
				</button>
				<button type="button" id="btn_info_Del">
					<div>삭제</div>
				</button>
				<button type="button" id="btn_info_save" class="info_save" tabindex="9">
					<div>저장</div>
				</button>
			</div>
		</div>
