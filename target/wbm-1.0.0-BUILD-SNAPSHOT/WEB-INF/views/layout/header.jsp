...
<header>
	<script>
		...
		let COMMONLEVEL = 70;
		let MANAGERLEVEL = 80;
		let SALES_CONFIRM_LEVEL = 0;
		let BEFCONTRACT_CONFIRM_LEVEL = 1;
		let AFTCONTRACT_CONFIRM_LEVEL = 2;
		let FINISHCONTRACT_CONFIRM_LEVEL = 3;
	</script>
	<div class="top_hd">
		<h1>
		...
		<nav class="main_nav">
			<ul>
				...
				<li><a href="main?gnb_index=0">계약관리</a>
					<ul class="main_2dep">
					<c:choose>
                		<c:when test="${loginLevel != null and loginLevel > 80}">
							<li><a href="main">계약관리</a></li>
				...
				<li><a href="inventory?gnb_index=1">제품관리</a>
					<ul class="main_2dep">
		...
		<div class="hd_right">
			<ul>
				...
				<li class="hd_user"><a href="#none" class="user_modal_btn click_outside_modal_btn">
						<div class="header_icon">
							<span></span>
						</div>
						<p>
					...
					<div class="user_info_modal click_outside_modal">
	...
	<div class="content_tit_wrap">
		<!-- <p>
			<a href="main" id="dep1_title"></a>
		</p>
		<span></span>
		<p>
			<a href="main" id="dep2_title"></a>
		</p> -->
	</div>
</header>
<!-- 헤더 끝 -->