                                            ...
                                            <div class="inputRow" data-role="selectBox">
                                                <div class="selectBox">
                                                    <button type="button" class="BtnSelect">
                                                        <div id="SortVal1">정렬</div>
                                                        <span class="iconSelect"></span>
                                                    </button>
                                                    <ul class="selectBoxOption">
                                                        <li class="optionName">정렬</li>
                                                        <li><button type="button" class="BtnOption">오름차순</button></li>
                                                        <li><button type="button" class="BtnOption">내림차순</button></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th style="min-width: 94px">계약일자</th>
                        ...
                        <th>구분</th>
                        <th>계약번호</th>
                        <th style="min-width: 94px">사업기간</th>
                        <th>업체명</th>
                        <th>제품발주</th>
                        <th>계약서발송</th>
                        <th>수금현황</th>
    ...
    <div class="modal_wrap">
        ...
        <div class="modal_main">
            ...
            <div id="new_contract_form">
                ...
                <!-- 계약 버튼 시작-->
                <div class="modal_bottom">
                    <button type="button" class="info_nextstep" value="2">
                        <div>다음단계</div>
                    </button>
                    <button type="button" class="info_prevstep" value="-2">
                        <div>이전단계</div>
                    </button>
