...
<main>
    <div class="content_wrap">
        ...
        <div class="bottom_content">
            <div class="total_num">전체수 : <span id="list_total_num">0</span>건</div>
...
<!-- modal 시작 -->
<div class="modal">
    <div class="modal_wrap comoute_modal">
        ...
        <div class="modal_main">
            ...
            <div id="new_compute_form">
                <form action="" id="form_compute_info" name="form_compute_info">
                    <div class="form_compute_rows_bundle">
                        <div class="input_row">
                            <div class="input_tit">
                                <i>물품식별번호(*)</i>
                            </div>
                            <div class="input_wrap">
                                <input type="text" id="text_identification_no" name="text_identification_no" tabindex="1"/>
                            </div>
                        </div>
                        <div class="input_row">
                            <div class="input_tit">
                            ...
                            <div class="input_wrap">
                                <input type="text" id="text_product_name" name="text_product_name" tabindex="2"/>
                            </div>
                        </div>
                    </div>
                    <div class="form_compute_rows_bundle">
                        <div class="input_row">
                            ...
                            <div class="input_wrap">
                                <input type="text" id="text_standard_size" name="text_standard_size" tabindex="3"/>
                            </div>
                        </div>
                        <div class="input_row">
                            <div class="input_tit">
                            ...
                            <div class="input_wrap">
                                <input type="text" id="text_product_price" name="text_product_price" tabindex="4"/>
                            </div>
                        </div>
                    </div>
                    <div class="form_compute_rows_bundle">
                        <div class="input_row">
                            ...
                            <div class="input_wrap">
                                <input type="text" id="text_product_count" name="text_product_count" tabindex="5" />
                            </div>
                        </div>
                        <div class="input_row">
                            <div class="input_tit">
                            ...
                            <div class="input_wrap">
                                <input type="text" id="text_total_price" name="text_total_price" tabindex="6"/>
                            </div>
                        </div>
                    </div>
                    <div class="form_compute_rows_bundle">
                        <div class="input_row">
                            ...
                            <div class="input_wrap">
                                <input type="text" id="text_commission_rate" name="text_commission_rate" tabindex="7"/>
                            </div>
                        </div>
                        <div class="input_row">
                            <div class="input_tit">
                            ...
                            <div class="input_wrap">
                                <input type="text" id="text_commission_price" name="text_commission_price" tabindex="8"/>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="input_wrap">
                            <div class="editor">
                                ...
                                <div class="editor_input">
                                    <div id="computeEditor" contenteditable="true" class="editor_box" tabindex="9"></div>
                                </div>
                            </div>
                        </div>
                    </div>
				...
				<div class="modal_bottom">
					<div>
						<button type="button" id="btn_info_edit" class="info_edit" tabindex="10">
							<div>수정</div>
						</button>
						<button type="button" id="btn_info_Del">
							<div>삭제</div>
						</button>
						<button type="button" id="btn_info_save" class="info_save" tabindex="10">
							<div>저장</div>
						</button>
					</div>
				</div>
