...
<main>
	<div class="content_wrap">
		...
		<div class="top_content">
			<div class="btn_sort_wrap">
				<div style="position: relative;">
					<button type="button" id="BtnSort" class="click_outside_modal_btn">
					...
					<div class="sortModal click_outside_modal">
						<div class="sortFormWrap">
							<div id="AddedsortList">
								<div class="sortListRow">
									<div class="sortTitle" sort_type="0">
										<span class="icon"></span>
										<p>계약일자</p>
									</div>
									<div class="inputRow" data-role="selectBox">
										<div class="selectBox">
											<button type="button" class="BtnSelect">
												<div id="SortVal1" class="selSortValue" value="-1">정렬</div>
								...
								<div class="sortListRow">
									<div class="sortTitle" sort_type="1">
										<span class="icon"></span>
										<p>수요처</p>
									</div>
									<div class="inputRow" data-role="selectBox">
										<div class="selectBox">
											<button type="button" class="BtnSelect">
												<div id="SortVal3" class="selSortValue" value="-1">정렬</div>
												<span class="iconSelect"></span>
											</button>
											<ul class="selectBoxOption">
												<li class="optionName"><button type="button" class="BtnOption" value="-1">정렬</button></li>
								...
								<div class="sortListRow">
									<div class="sortTitle" sort_type="2">
										<span class="icon"></span>
										<p>발주처</p>
									</div>
									<div class="inputRow" data-role="selectBox">
								...
								<div class="sortListRow">
									<div class="sortTitle" sort_type="3">
										<span class="icon"></span>
										<p>건명(사업명)</p>
									</div>
									<div class="inputRow" data-role="selectBox">
								...
								<div class="sortListRow">
									<div class="sortTitle" sort_type="4">
										<span class="icon"></span>
										<p>계약금액</p>
									</div>
									<div class="inputRow" data-role="selectBox">
			...
			<div class="detail_search_wrap">
				<label for="">사업기간</label> <input type="date" id="txt_bus_sdate" name="txt_bus_sdate" /> <input type="date" id="txt_bus_edate" name="txt_bus_edate" />
			</div>
			<!-- 
			<div class="detail_search_wrap">
				<label for="num_bill_year">계산서발행년도</label> <input type="number" id="num_bill_year" name="num_bill_year" min="2000" max="3000" step="1" />
			</div>
			 -->
			...
			<table>
				<thead>
					<tr>
						...
						<th style="min-width: 130px">계약업체</th>
						<th style="min-width: 130px">구분</th>
						<th style="min-width: 115px">수요처</th>
						<th style="min-width: 115px">발주처</th>
						<th>사업명</th>
						<th style="min-width: 114px">사업기간</th>
						<th style="min-width: 114px">하자기간</th>
						<th style="min-width: 114px">계약일자</th>
						...
						<th style="min-width: 82px">작성자</th>
						<th style="min-width: 114px">작성일</th>
		...
		<div class="bottom_content">
			...
			<div class="total_num">
				<span id="checkec_info"></span>
			</div>
			<div class="total_num">
				<span id="total_info"></span>
			</div>
			...
			<div class="btn_wrap top_right">
				<c:choose>
					<c:when test="${loginLevel != null and loginLevel > 70}">
						<button type="button" class="btn_prevStep step_btn" value="-1">
							<div>
				...
				<button type="button" class="btn_nextStep step_btn" value="1">
					<div>
						<p>다음 단계 이동</p>
						<span class="level_icon"></span>
					</div>
	...
	<div class="modal_wrap">
		...
		<div class="modal_main">
			...
			<div id="new_business_form">
				<form action="" id="formSalesInfo" name="formSalesInfo" enctype="multipart/form-data" onsubmit="return false;">
					<div style="display: flex; flex-direction: column; gap: 10px; padding: 30px">
						<div class="form_top">
							...
							<div class="form_left">
								<div class="input_row">
									...
									<div class="input_wrap">
										<div class="select_box">
											<select name="salesUserCate" id="salesUserCate" tabindex="1">
												<option value="0">선택</option>
											</select>
											<span class="select_icon"></span>
										</div>
								...
								<div class="input_row">
									...
									<div class="input_wrap">
										<input type="text" id="salesDemand" name="salesDemand" tabindex="2" />
									</div>
								</div>
								<div class="input_row">
									<div class="input_tit">
									...
									<div class="input_wrap">
										<input type="text" id="salesOrder" name="salesOrder" tabindex="3" />
									</div>
								</div>
								<!-- 
								<div class="input_row">
								...
								<div class="input_row">
									...
									<div class="input_wrap inputs_bundle">
										<input type="text" class="currencyPrice" id="salesContractPrice" name="salesContractPrice" placeholder="VAT포함" tabindex="4" /><input class="currencyPrice" type="text" id="salesContractVat" name="salesContractVat" placeholder="VAT별도" tabindex="5" />
										<button type="button" class="btn_auto_calculate" tabindex="6">
							...
							<div class="form_right">
								...
								<div class="input_row">
									...
									<div class="input_wrap">
										<input type="text" id="salesBusName" name="salesBusName" tabindex="7" />
									</div>
								</div>
								<div class="input_row">
									<div class="input_tit">
									...
									<input type="date" id="salesBusSTime" name="salesBusSTime" tabindex="8" /> <input type="date" id="salesBusETime" name="salesBusETime" tabindex="9" />
								</div>
								<div class="input_row">
									<div class="input_tit">
										<i>하자기간</i>
									...
									<input type="date" id="salesServiceSTime" name="salesServiceSTime" tabindex="10" /> <input type="date" id="salesServiceETime" name="salesServiceETime" tabindex="11" />
								</div>
							</div>
							<!-- 신규영업등록 모달 오른쪽 끝 -->
						</div>
						<div class="form_bottom" style="width: 100%">
							<div class="input_row">
								...
								<input type="text" id="salesComment" name="salesComment" tabindex="12" />
							</div>
							<!-- 신규영업 첨부파일 시작-->
					...
					<div class="modal_bottom">
						<button type="button" id="btn_info_nextstep" class="info_nextstep step_btn" value="1" style="margin-right: auto">
							<div>
								<i>다음 단계 이동</i> <span></span>
							</div>
						</button>
						<!-- 
                        <button type="button" id="btn_info_prevstep" class="info_prevstep" value="-1">
                         ...
                         -->
						<button type="button" id="btn_info_save" class="info_save" tabindex="13">
							<div>저장</div>
						</button>
						<button type="button" id="btn_info_edit" class="info_edit" tabindex="13">
							<div>수정</div>
						</button>
			...
			<div id="new_contract_form">
						...
						<div style="display: flex; gap: 20px">
							<div class="form_left">
								...
								<div class="input_row">
									...
									<div class="input_wrap">
										<div class="select_box">
											<select name="contractCompany" id="contractCompany">
												<option value="0">선택</option>
											</select>
											<span class="select_icon"></span>
										</div>
								...
								<div class="input_row">
									...
									<div class="input_wrap inputs_bundle">
										<input type="date" id="contractBusSTime" name="contractBusSTime" /> <input type="date" id="contractBusETime" name="contractBusETime" />
									</div>
								</div>
								<div class="input_row">
									<div class="input_tit">
									...
									<div class="input_wrap inputs_bundle">
										<input type="date" id="contractServiceSTime" name="contractServiceSTime" /> <input type="date" id="contractServiceETime" name="contractServiceETime" />
									</div>
								</div>
								<div class="input_row">
									<div class="input_wrap inputs_bundle">
							...
							<div class="form_top">
										...
										<div class="form_top_2">
											<div class="input_group">
												...
												<div class="input_row">
													...
													<div class="input_wrap btn_onoff">
														<input type="checkbox" name="payCheck" id="payCheck" value="1" /> <label for="payCheck"></label>
													</div>
												</div>
												<div class="input_row">
													<div class="input_tit">
													...
													<div class="input_wrap btn_onoff">
														<input type="checkbox" name="billType" id="billType" value="1" /> <label for="billType"></label>
													</div>
												</div>
												<div class="input_row">
													<div class="input_tit">
													...
													<!-- <div class="input_wrap"><i>수금</i> <input type="checkbox" name="payCollect" id="payCollect" class="" value="1" /> <label for="payCollect"></label></div> -->
													<div class="input_wrap btn_onoff">
														<input type="checkbox" name="payCollect" id="payCollect" value="1" /> <label for="payCollect"></label>
													</div>
												</div>
											</div>
								...
								<div class="form_top_1">
									...
									<div class="input_row">
										...
										<div class="input_wrap inputs_bundle">
											<input type="text" class="currencyPrice" id="payContractPrice" name="payContractPrice" placeholder="VAT포함" /> <input class="currencyPrice" type="text" id="payContractPriceVat" name="payContractPriceVat" placeholder="VAT별도" />
											<button type="button" class="btn_auto_calculate">
												<span class="icon_calculate" title="자동계산"></span>
											</button>
										</div>
								...
								<table>
									<thead>
										<tr>
											...
											<th>업체명</th>
											<th>구분</th>
											<th>금액<br /> <span class="vat_desc">(VAT포함)</span>
											</th>
											<th>금액<br /> <span class="vat_desc">(VAT별도)</span>
											</th>
											<th>매출구분</th>
											<th>계산서요청일자</th>
											<th>검수</th>
				...
				<!-- 계약 버튼 시작-->
				<div class="modal_bottom">
					<button type="button" class="info_prevstep step_btn" id="contract_info_prevstep" value="-2">
						<div>
							<span></span> <i>이전 단계 이동</i>
						</div>
					</button>
			...
			<div id="new_Purchase_form">
				<!-- 매입 폼 시작 -->
				<form action="" class="contract_tabItem" data-tabNum="3" id="formPurchaseInfo" name="formPurchaseInfo" enctype="multipart/form-data" style="display: none" onsubmit="return false;">
					<!-- 계약금 시작 -->
					<!-- 
                    <div class="purchase_wrap">
                        <div class="input_row">
                            ...
                            <div class="input_wrap inputs_bundle">
                                ...
                                <button type="button" class="btn_auto_calculate_rate" id="btn_auto_calculate_rate" style="padding: 6px">
                                    <span class="icon_calculate" title="자동계산"></span>
                                </button>
                            </div>
                        </div>
							...
							<div class="form_top">
								<div class="form_left">
									...
									<div class="input_row">
										...
										<div class="input_wrap inputs_bundle">
											<input type="text" class="currencyPrice" id="productPrice" name="productPrice" placeholder="VAT포함" /> <input type="text" class="currencyPrice" id="productPriceVat" name="productPriceVat" placeholder="VAT별도" />
											<button type="button" class="btn_auto_calculate">
												<span class="icon_calculate" title="자동계산"></span>
											</button>
										</div>
									...
									<div class="input_row">
										...
										<div class="input_wrap inputs_bundle">
											...
											<div class="select_box">
											 ...
											 -->
											<input type="text" id="productNameOther" name="productNameOther"/>
										</div>
									</div>
									<div class="input_row">
										<div class="input_tit">
										...
										<table>
											<thead>
												<tr>
													...
													<th>제품명</th>
													<th>수량</th>
													<th>단가<br /> <span class="vat_desc">(VAT포함)</span>
													</th>
													<th>단가<br /> <span class="vat_desc">(VAT별도)</span>
													</th>
													<th>정산율</th>
													<th>메모</th>
													<th>삭제</th>
							...
							<div class="form_top">
								<div class="form_left">
									...
									<div class="input_row">
										...
										<div class="input_wrap inputs_bundle">
											<input type="text" id="workPrice" class="currencyPrice" name="workPrice" placeholder="VAT포함" /> <input type="text" class="currencyPrice" id="workPriceVat" name="workPriceVat" placeholder="VAT별도" />
											<button type="button" class="btn_auto_calculate">
												<span class="icon_calculate" title="자동계산"></span>
											</button>
										</div>
							...
							<div class="file_wrap">
								<div class="filebox">
									<div style="display: flex; gap: 5px">
										...
										<div class="btn_file active">
											<label for="purchaseFileInput">내PC</label> <input type="file" id="purchaseFileInput" name="purchaseFileInput" multiple />
										</div>
									</div>
									<div class="preview_tab_wrap">
										<div class="preview_tab_content">
					...
					<div class="modal_bottom">
						...
						<button type="button" id="purchase_info_del">
							<div>삭제</div>
						</button>
					</div>
					<!-- 매입 버튼 끝 -->
