        ...
        <div class="modal_main">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 10px; padding: 30px">
                        ...
                        <div class="form_bottom" style="width: 100%">
                            <div class="input_row">
                                ...
                                <input type="text" id="businessEditor" name="businessEditor" />
                            </div>
                            <!-- 신규영업 첨부파일 시작-->
            ...
            <div id="new_contract_form">
                ...
                <div id="modalContractAdmin">
                    <!-- 관리자 작성폼 시작 -->
                    <form action="" id="formContractAdmin">
                            ...
                            <div class="form_top">
                                ...
                                <div class="form_right">
                                    <div class="input_row">
                                        ...
                                        <div class="input_wrap"><i>수금</i> <input type="checkbox" name="payCollect" id="payCollect" class="수금완" value="1" /> <label for="payCollect"></label></div>
                                    </div>
                                </div>
                                <div class="form_right">
                                    <div class="input_row">
                                        ...
                                        <div class="input_wrap">발행완료<input type="radio" name="billType" id="finishBillType" class="수금완" value="1" /> <label for="finishBillType"></label> 발행취소<input type="radio" name="billType" id="cancelBillType" class="수금완" value="0" /> <label for="cancelBillType"></label></div>
                                    </div>
                                </div>
                                <!-- 관리자 작성폼 왼쪽 모달 오른쪽 끝 -->
                            </div>
                        ...
                        <div class="form_wrap" style="display: flex; flex-direction: column; gap: 10px; height: 100%">
                            <div class="form_top">
                                ...
                                <div class="input_row">
                                    ...
                                    <div class="input_wrap">
                                        <!-- <input type="text" id="contractReadyMoneyMemo" name="contractReadyMoneyMemo"> -->
                ...
                <div class="modal_bottom">
                    <button type="button" id="contract_admin" class="admin_btn">관리자</button>
