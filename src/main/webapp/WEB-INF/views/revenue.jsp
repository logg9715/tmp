...
<main>
    <div class="content_wrap">
        ...
        <form action="#" id="form_search_revenue" name="form_search_revenue">
            <div class="top_content">
                            ...
                            <form action="" id="sortForm">
                                <div class="sortFormWrap">
                                    <div id="AddedsortList">
                                        ...
                                        <div class="sortListRow">
                                            <div class="sortTitle" sort_type="5">
                                                <span class="icon"></span>
                                                <p>매출금액</p>
                                            </div>
                                            <div class="inputRow" data-role="selectBox">
                                        ...
                                        <div class="sortListRow">
                                            <div class="sortTitle" sort_type="6">
                                                <span class="icon"></span>
                                                <p>계산서발행일</p>
                                            </div>
                                            <div class="inputRow" data-role="selectBox">
                ...
                <div class="detail_search_wrap">
                    ...
                    <input type="number" id="num_bill_year" name="num_bill_year" min="2000" max="3000" step="1" />
                </div>
                <div class="search_wrap">
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th style="min-width: 180px">수요처</th>
                        <th style="min-width: 115px">발주처(계약사)</th>
                        <th style="min-width: 350px">건명(사업명)</th>
                        <th style="min-width: 30">매입</th>
                        ...
                        <!--                         <th style="min-width: 100px;">제품발주</th> -->
                        <th style="min-width: 100px">계약서발송</th>
                        <th style="min-width: 100px">수금현황</th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="totalTr" style="height: 28px; position: sticky; background: #e4eaf0; top: 40px; z-index: 5">
                        <td colspan="9">총액</td>
        ...
        <div style="display: flex; flex-direction: row; gap: 5px; position: relative; justify-content: space-between;">
            ...
            <!-- 컨텐츠 하단(전체수, 페이지네이션, 삭제버튼) 끝-->
             <div style="color: #555; display: flex;">
                 <div class="total_num">
                     <span id="checkec_info">
                        <!-- <div><p>선택된 체크박스 : </p> <b>100개</b></div>
                        <div><p>계약금액 총합<span>(vat포함)</span> : </p> <b>10000000</b></div>
                        <div><p>계약금액 총합<span>(vat별도)</span> : </p> <b>100000421</b></div> -->
                     </span>
                 </div>
                 <div class="total_num">
    ...
    <div class="modal_wrap">
        ...
        <div class="modal_main">
            ...
            <div id="new_contract_form">
                    ...
                    <form action="" class="contract_tabItem active" data-tabNum="1" id="formContractInfo" name="formContractInfo" enctype="multipart/form-data">
                        ...
                        <div style="display: flex; gap: 20px">
                            <div class="form_left">
                                ...
                                <div class="input_row" style="flex-direction: row;">
                                    <i>계약서 발송</i>
                                    <!-- <input type="checkbox" name="contractSend" id="contractSend" /> <label for="contractSend"></label> -->
                                    <div class="input_wrap btn_onoff"><input type="checkbox" name="contractSend" id="contractSend" value="1" /> <label for="contractSend"></label></div>
                                </div>
                            </div>
                            <!-- 신규계약등록 모달 왼쪽 끝 -->
                            <!-- 신규계약등록 모달 오른쪽 시작 -->
                ...
                <!-- 계약 버튼 시작-->
                <div class="modal_bottom">
                    <button type="button" class="info_prevstep step_btn" id="contract_info_prevstep" value="-1" style="margin-right: auto">
                        <div>
                            <span></span>
                            <i>이전 단계 이동</i>
                        </div>
