...
$(document).ready(function () {
    ...
    function listRevenueInfo(pageIndex, isRefresh = 0) {
        ...
        for (let keyValue of resultJson.resultData) {
            ...
            resultData += "</td>";
            resultData += "<td>" + numberWithCommas(Number(keyValue.tsi_contract_price)) || 0 + "</td>";
            resultData += "<td>" + numberWithCommas(Number(keyValue.tsi_contract_vat)) || 0 + "</td>";
            resultData += "<td>" + numberWithCommas(Number(keyValue.tpi_price)) || 0 + "</td>";
            resultData += "<td>" + numberWithCommas(Number(keyValue.tpi_price_vat)) || 0 + "</td>";
