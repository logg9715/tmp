    ...
    function listRevenueInfo(pageIndex, isRefresh = 0) {
        ...
        for (let keyValue of resultJson.resultData) {
            ...
            */
            ...
            if(keyValue.tsi_confirm_level == 0) resultData += "<td>영업관리</td>";
            else if(keyValue.tsi_confirm_level == 1) resultData += "<td>계약전</td>";
            else if(keyValue.tsi_confirm_level == 2) resultData += "<td>계약관리</td>";
            else if(keyValue.tsi_confirm_level > 2) resultData += "<td>계약완료</td>";
