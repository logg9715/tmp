...
$(document).ready(function () {
    ...
    function $listSectionInfo() {
        const resultData = [{ section: "물품 계약" }, { section: "지급자 재계약" }, { section: "공사 계약" }, { section: "물품 계약" }];
    ...
    */
    ...
    $(document).on("click", "#sectionList tr", function () {
        $("#sectionList tr").removeClass("active");
    ...
    $(document).on("click", "#contractorList tr", function () {
        $("#contractorList tr").removeClass("active");
        $(this).addClass("active");
        let value = $(this).find("td:nth-child(2)").text();
    ...
    $("#btn_add_section , #btn_edit_section").click(function () {
        ...
        if (selId == "btn_add_section") {
            modal.find("#sectionList tr").removeClass("active");
            if (inputVal == "") {
                alert("추가할 항목을 작성해주세요.");
            } else {
                action_popup.confirm("항목을 추가하시겠습니까?", function (res) {
                    if (res) {
                    }
                    changePopupMessage("추가가 완료되었습니다.");
                    modal.find("#input_section").val("");
                });
            }
        } else if (selId == "btn_edit_section") {
            if (inputVal == "") {
                alert("수정할 항목을 선택해주세요.");
            } else {
                action_popup.confirm("선택한 항목을 수정하시겠습니까?", function (res) {
                    if (res) {
                    }
                    changePopupMessage("수정이 완료되었습니다.");
                    modal.find("#input_section").val("");
                });
            }
        }
    ...
    $("#btn_del_section").click(function () {
        action_popup.confirm("선택한 항목을 삭제하시겠습니까?", function (res) {
            if (res) {
            }
    ...
    $("#btn_add_contractor , #btn_edit_contractor").click(function () {
        ...
        if (selId == "btn_add_contractor") {
            modal.find("#sectionList tr").removeClass("active");
            if (inputVal == "") {
                alert("추가할 항목을 작성해주세요.");
            } else {
                action_popup.confirm("업체를 추가하시겠습니까?", function (res) {
                    if (res) {
                    }
                    changePopupMessage("추가가 완료되었습니다.");
                    modal.find("#input_contractor").val("");
                });
            }
        } else if (selId == "btn_del_contractor") {
            if (inputVal == "") {
                alert("수정할 업체를 선택해주세요.");
            } else {
                action_popup.confirm("선택한 업체를 수정하시겠습니까?", function (res) {
                    if (res) {
                    }
                    changePopupMessage("수정이 완료되었습니다.");
                    modal.find("#input_contractor").val("");
    ...
    //계약 업체 관리 삭제 동작
    $("#btn_del_section").click(function () {
        action_popup.confirm("선택한 업체를 삭제하시겠습니까?", function (res) {
            if (res) {
            }
            changePopupMessage("삭제가 완료되었습니다.");
            modal.find("#input_contractor").val("");
